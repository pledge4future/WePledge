...
export function BusinessTripForm(props: {
  error?: boolean;
    ...
    <>
      <form onSubmit={formik.handleSubmit}>
        ...
        <Grid container spacing={2} alignItems="center" justifyContent="center">
          ...
          <Grid item xs={8}>
            ...
            <Select
              ...
              endAdornment={
                <InputFieldTooltip
                  position={"end"}
                  text={tooltips.transportationMode}
          ...
          {formik.values.transportationMode && formik.values.transportationMode === "Bus" && (
            <React.Fragment>
              <Grid item xs={8}>
          ...
          {formik.values.transportationMode && formik.values.transportationMode === "Plane" && (
            <React.Fragment>
              <Grid item xs={8}>
          ...
          {formik.values.transportationMode && formik.values.transportationMode === "Car" && (
            <>
              <Grid item xs={8}>
                <TextField
                  fullWidth
                  ...
                  type="number"
                  InputProps={{
                    endAdornment: <InputFieldTooltip position={"end"} text={tooltips.passengers} />,
                  }}
      ...
      <UnderConstructionDialog
        feature="Entering of Addresses"
        isOpen={addressMode}
        handleDialogClose={() => setAddressMode(false)}
      ></UnderConstructionDialog>
    </>
  );
}
