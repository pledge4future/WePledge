...
from .schema.auth import AuthMutation
from .schema.heating import CreateHeating
from .schema.electricity import CreateElectricity
from .schema.commuting import CreateCommuting
from .schema.businessTrips import CreateBusinessTrip, PlanTrip
from .schema.workingGroup import CreateWorkingGroup, SetWorkingGroup
